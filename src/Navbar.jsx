        ...
        <>
            ...
            <nav className="bg-[#212529] py-[10px] flex justify-between items-center px-[8%] tablet:px-[6%] mobile:px-[4%]">
                <Link to="/" className="brand">
                    <h1 className="logo text-[#ffc107] text-5xl tablet:text-4xl mobile:text-2xl mobile_m:text-xl">Pastours<span className="material-symbols-outlined bg-[#ffc107f1] text-black rounded-[50%] text-[18px] relative top-[-12px] tablet:text-[14px] mobile:text-[12px] mobile_m:text-[10px]">electric_bolt</span></h1>
