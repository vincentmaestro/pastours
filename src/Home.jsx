    ...
    return (
        <>
            ...
            <section className="why-us bg-orange-200 py-6 tablet:py-2 mobile:pb-4 border-b border-slate-100">
                ...
                <p className="w-[75%] mx-auto text-lg font-light laptop_s:w-[85%] tablet:text-base mobile:text-sm">Situated in the heart of the city with networks and routes optimised to deliver effective service rendering. Pastours is goal-driven company committed to giving only the best to our customers. Our vision is to see what you need delivered to you right on time</p>
            </section>
            <Footer />
        </>
    );
